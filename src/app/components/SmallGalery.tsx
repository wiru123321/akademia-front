...
export default function SmallGalery({ data }: SmallGaleryProps) {
  return (
    <section className="py-12 md:py-20 opacity-0 intersect:animate-fade animate-duration-[1500ms] intersect-once intersect-half">
            ...
            <div className="h-64 mb-6">
              {data.picture.data[1] && (
                <Image
                  ...
                  height={1000}
                  width={1200}
                  alt={data.picture.data[1].attributes.alternativeText}
              ...
              <div className="w-1/2 h-64 px-3">
                {data.picture.data[2] && (
                  <Image
                    ...
                    height={1000}
                    width={1200}
                    alt={data.picture.data[2].attributes.alternativeText}
                    src={data.picture.data[2].attributes.url}
                  />
                )}
              </div>
              <div className="w-1/2 h-64 px-3">
                {data.picture.data[3] && (
                  <Image
                    ...
                    height={1000}
                    width={1200}
                    alt={data.picture.data[3].attributes.alternativeText}
                    src={data.picture.data[3].attributes.url}
                  />
                )}
              </div>
            </div>
