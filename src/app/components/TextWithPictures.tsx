...
export default function TextWithPictures({ data }: TextWithPictureProps) {
    return (
        <>
            <section className="container py-10 px-4 md:px-10 mx-auto m:py-12 lg:py-24">
                        ...
                        >
                            <SwiperSlide className="flex  items-center justify-center rounded-2xl">
                                <Image
                                    ...
                                    alt={
                                        data.pictures.data[0].attributes
                                            .alternativeText
                                    }
                                    width={290}
                                    height={320}
                            ...
                            <SwiperSlide className="flex  items-center justify-center rounded-2xl">
                                <Image
                                    ...
                                    alt={
                                        data.pictures.data[1].attributes
                                            .alternativeText
                                    }
                                    width={290}
                                    height={320}
                            ...
                            <SwiperSlide className="flex  items-center justify-center rounded-2xl">
                                <Image
                                    ...
                                    alt={
                                        data.pictures.data[2].attributes
                                            .alternativeText
                                    }
                                    width={290}
                                    height={320}
